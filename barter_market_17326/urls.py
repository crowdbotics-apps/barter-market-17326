"""barter_market_17326 URL Configuration
...
admin.site.site_header = "Barter Market"
admin.site.site_title = "Barter Market Admin Portal"
admin.site.index_title = "Barter Market Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Barter Market API",
        default_version="v1",
        description="API documentation for Barter Market App",
    ),
    public=True,
